...
public class PlayerMap {
	...
	public static void main(String[] args) {
		...
		Map<String, List<Player>> ipl2025 = new HashMap<>();

		ipl2025.put("MI", mi2025);
		ipl2025.put("GT", gt2025);
		ipl2025.put("PBSK", pbsk2025);
		ipl2025.put("RCB", rcb2025);

		System.out.println(ipl2025);

		for (String name : ipl2025.keySet()) {
			System.out.println(ipl2025.get(name));
			for (Player player : ipl2025.get(name)) {
